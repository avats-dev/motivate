...
def quote():
    ...
    with open(filename) as json_data:
        try:
            ...
            print("   However JSON does not support that. Please use '\\n' or '\\t'.")
            print("For later actions, I wrote this filename to JSON_ERROR_LIST.txt.")
            print("I suggest you to test that json file in this website: https://jsonlint.com")
        ...
        if "quote" in quotes["data"][ran_no]:
            ...
            print("No key 'quote' is found in the file: {filename}, item_index = {ran_no}")
